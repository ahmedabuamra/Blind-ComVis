package abuamra.opjectRecognition.isef;
...
import abuamra.opjectRecognition.isef.GPIO;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    pb = new ProcessBuilder("espeak","-ven+f3" , "\"Objects Recognition mode... Handeling,, Please wait\"");
		...
		CvHaarClassifierCascade CarClassifier1 = loadHaarClassifier(
				"/home/odroid/HaarCascadeXMLs/CarDetect-master/carcascade_full_14.xml");
		CvHaarClassifierCascade CarClassifier2 = loadHaarClassifier(
				"/home/odroid/HaarCascadeXMLs/CarDetect-master/carcascade_pics_at_tollnaka_12_stages.xml");
		CvHaarClassifierCascade CarClassifier3 = loadHaarClassifier(
				"/home/odroid/HaarCascadeXMLs/CarDetect-master/carcascade.xml");
		CvHaarClassifierCascade CarClassifier4 = loadHaarClassifier(
				"/home/odroid/HaarCascadeXMLs/CarDetect-master/carcascade_full_18.xml");


		CvHaarClassifierCascade wallClockClassifire = loadHaarClassifier("/home/odroid/HaarCascadeXMLs/WallClock/classifierWallClock.xml");
...
//					CvScalar.GREEN, 
					grayImage,mirrorImage , "Car in front you");
...
//					CvScalar.YELLOW,
					grayImage,mirrorImage , "Wall Clock in front you");
...
//					colour, 1, CV_AA, 0);
			...
			pb = new ProcessBuilder("espeak" , "\""+ speech + "\"");
			pb.redirectErrorStream(true);
			pb.start();
		    Thread.sleep(2000);
