...
import abuamra.faceRecognition.isef.FacialRecognition.PotentialFace;
...
public class TEST5 extends JApplet implements Runnable, MouseListener  {
	...
	public void mouseClicked(MouseEvent evt) {
		...
		for(Rectangle r : currentFaces) {
		    	...
		    	pb = new ProcessBuilder("espeak","-ven+f3" , "\""+ "please, give me the person is name" + "\"");
		    	pb.redirectErrorStream(true);
...
//		        final String name = (String) JOptionPane.showInputDialog(null, "Save as?", "Tag", JOptionPane.QUESTION_MESSAGE, preview, null, null);
			    	...
			    	int recorCounter = db.idCounter-1;
			    	pb = new ProcessBuilder("arecord","-d 3", "/root/workspace/FaceRecognition/soundNames/"+String.valueOf(recorCounter)+".wav");
			    	pb.redirectErrorStream(true);
